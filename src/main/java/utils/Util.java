...
public class Util {
 ...
 public static final int WAIT_TIME = 30; // Delay time to wait the website
					    // launch completely
 public static final String BASE_URL = "https://dev.tripi.vn/";

 // Expected output
 public static final String EXPECT_TITLE = "Tripi.vn - Đặt vé máy bay và khách sạn thuận tiện với giá tốt nhất";
 public  final String EXPECT_ERROR1 = "Mật khẩu không hợp lệ";
 public  final String EXPECT_ERROR2 = "Tài khoản chưa được đăng ký tại hệ thống";
